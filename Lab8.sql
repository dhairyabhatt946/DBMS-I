...
SELECT REGION, COUNT(DISTINCT PRODUCT) AS PRODUCTS
FROM SALES_DATA
GROUP BY REGION
...
SELECT REGION, MAX(SALES_AMOUNT) AS MAXIMUM_SALARY
FROM SALES_DATA
GROUP BY REGION
...
SELECT PRODUCT, AVG(SALES_AMOUNT) AS AVERAGE_SALARY
FROM SALES_DATA
GROUP BY PRODUCT
...
SELECT REGION, AVG(SALES_AMOUNT) AS AVERAGE_SALARY
FROM SALES_DATA
WHERE YEAR = 2023
GROUP BY REGION
